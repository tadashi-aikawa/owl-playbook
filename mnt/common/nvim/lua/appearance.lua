...
vim.api.nvim_set_hl(0, "RenderMarkdownH2Bg", { bg = "#58535f" })
vim.api.nvim_set_hl(0, "RenderMarkdownH3Bg", { fg = "#FFC777", bg = "#493e4a" })
...
vim.api.nvim_set_hl(0, "@markup.heading.3.markdown", { fg = "#FFC777", bg = "#493e4a" })
