...
# git log
function gls()   { git-graph -n 30}
function gll()   { git-graph -n 60 --format "%h %as %d %s (%an)"}
...
$env:JAVA_HOME = $env:LOCALAPPDATA + "\JetBrains\Toolbox\apps\IDEA-U\ch-0\232.8660.185\jbr"
